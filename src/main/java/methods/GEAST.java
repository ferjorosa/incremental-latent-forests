...
public class GEAST implements ContinuousMethod {
    ...
    public void runContinuous(List<Tuple<DataOnMemory<DataInstance>, DataOnMemory<DataInstance>>> folds,
        ...
        /* Run */
        List<Tuple4<Gltm, Double, Double, Long>> results = run(folds, run, foldLogLevel);
        ...
        /* Store models */
        storeContinuousModels(models, "results/run_"+run+"/continuous/"+dataName+"/" + folds.size() +
    ...
    private List<Tuple4<Gltm, Double, Double, Long>> run(List<Tuple<DataOnMemory<DataInstance>, DataOnMemory<DataInstance>>> folds,
                                                         int run,
                                                         LogUtils.LogLevel foldLogLevel) throws Exception {
        ...
        for(int i = 0; i < folds.size(); i++) {
            ...
            /* Store model */
            storeContinuousModel(result.model(), i, "results/run_"+run+"/continuous/"+dataNameAttribute+"/"
