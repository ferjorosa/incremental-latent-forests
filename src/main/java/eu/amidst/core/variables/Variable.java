 ...
 */
 public interface Variable {
    ...
    /**
     * Returns a copy of the variable with all its fields being copied (except the Attribute where it will share the reference)
     * @return a copy of the variable with all its fields being copied (except the Attribute where it will share the reference)
     */
    Variable deepCopy();
     ...
     void setDistributionTypeEnum(DistributionTypeEnum distributionTypeEnum);
