package experiments.util.result;
...
public class ExperimentResult {
    ...
    private Map<String, FoldResult> folds;
    ...
    public Map<String, FoldResult> getFolds() {
        return folds;
    }

    public void setFolds(Map<String, FoldResult> folds) {
        this.folds = folds;
    }
}
