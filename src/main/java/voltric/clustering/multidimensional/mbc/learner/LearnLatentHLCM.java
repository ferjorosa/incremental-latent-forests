...
/**
 * Clase estatica diseñada para que se pueda aprender modelos MBC latentes con forma de arbol. Un aspecto relevante es que
 * realmente no se restringe a modelos de arbol sino mas bien a FOREST, ya que la forma de eliminar variables latentes
 * del operador {@link voltric.clustering.multidimensional.mbc.operator.RemoveLatentNode} asi lo permite.
 *
 * El tipo de estructura que sera generada por tanto cuenta unicamente con arcos en Class y Bridge con forma de arbol
 * o forest.
 *
