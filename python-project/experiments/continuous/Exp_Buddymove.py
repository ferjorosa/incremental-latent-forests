...
class Exp_Buddymove(ContinuousExperiment.ContinuousExperiment):
    ...
    # 6 data attributes after filtering with 10 folds
    meta_types = [MetaType.REAL, MetaType.REAL, MetaType.REAL, MetaType.REAL, MetaType.REAL, MetaType.REAL]
    var_types_string = "cccccc"
